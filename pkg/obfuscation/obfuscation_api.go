...
func (a *Obfuscation) LogConfigurationsCreateObfuscationExpression(
	accountID int,
...
// Create an obfuscation expression.
func (a *Obfuscation) LogConfigurationsCreateObfuscationExpressionWithContext(
	ctx context.Context,
	accountID int,
	expression LogConfigurationsCreateObfuscationExpressionInput,
) (*LogConfigurationsObfuscationExpression, error) {
...
func (a *Obfuscation) LogConfigurationsUpdateObfuscationExpression(
	accountID int,
...
// Update an existing data partition rule.
func (a *Obfuscation) LogConfigurationsUpdateObfuscationExpressionWithContext(
	ctx context.Context,
	accountID int,
	expression LogConfigurationsUpdateObfuscationExpressionInput,
) (*LogConfigurationsObfuscationExpression, error) {
...
func (a *Obfuscation) GetObfuscationExpressions(
	accountID int,
) (*[]LogConfigurationsObfuscationExpression, error) {
...
// Look up for all obfuscation expressions for a given account
func (a *Obfuscation) GetObfuscationExpressionsWithContext(
	ctx context.Context,
	accountID int,
) (*[]LogConfigurationsObfuscationExpression, error) {
